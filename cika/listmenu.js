const listmenu = (prefix) => { 
	return ` *LIST MENU CIKABOT*
	
	
╭─「 *MEDIA DOWNLOADER* 」──
├➲ *${prefix}tiktokstalk [username]*
├➲ *${prefix}igstalk [@agus_alnsyh]*
├➲ *${prefix}insta [Link]*
...
├➲ *${prefix}pasangan [Agus/Cika]*
├➲ *${prefix}gantengcek [Agus]*
├➲ *${prefix}cantikcek [Agus]*
├➲ *${prefix}artinama [Agus]*
├➲ *${prefix}persengay [Agus]*
├➲ *${prefix}pbucin [Agus]*
├➲ *${prefix}bpfont [Agus]*
├➲ *${prefix}textstyle [Agus Nesta]*
├➲ *${prefix}jadwaltv [GTV]*
...
├➲ *${prefix}cphlogo [Agus/Nesta]*
├➲ *${prefix}cglitch [Agus/Nesta]*
├➲ *${prefix}cpubg [Agus/Nesta]*
├➲ *${prefix}cml [Agus/Nesta]*
├➲ *${prefix}tahta [Cika]*
├➲ *${prefix}croman [Agus dan Cika]*
├➲ *${prefix}cthunder [Agus Nesta]*
├➲ *${prefix}cbpink [Agus Nesta]*
├➲ *${prefix}cmwolf [Agus Nesta]*
├➲ *${prefix}csky [Agus Nesta]*
├➲ *${prefix}cwooden [Agus Nesta]*
├➲ *${prefix}cflower [Agus Nesta]*
├➲ *${prefix}clove [Agus Nesta]*
├➲ *${prefix}ccrossfire [Agus Nesta]*
├➲ *${prefix}cnaruto [Agus Nesta]*
├➲ *${prefix}cparty [Agus Nesta]*
├➲ *${prefix}cshadow [Agus Nesta]*
├➲ *${prefix}cminion [Agus Nesta]*
├➲ *${prefix}cneon [Agus Nesta]*
├➲ *${prefix}cneon2 [Agus Nesta]*
├➲ *${prefix}cneongreen [Agus Nesta]*
├➲ *${prefix}c3d [Agus Nesta]*
├➲ *${prefix}csky [Agus Nesta]*
├➲ *${prefix}tts [id Haii]*
├➲ *${prefix}ttp [Agus Nesta]*
├➲ *${prefix}slide [Agus Nesta]*
├➲ *${prefix}stiker*
├➲ *${prefix}gifstiker*
├➲ *${prefix}toimg*
├➲ *${prefix}img2url*
